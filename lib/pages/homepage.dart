import 'dart:convert';
import 'package:covid/pages/country.dart';
import 'package:url_launcher/url_launcher.dart';
import 'package:covid/data/datasource.dart';
import 'package:covid/data/faq.dart';
...
class _HomepageState extends State<Homepage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Center(child: Text("Covid Tracker App")),
        centerTitle: true,
            ...
            Row(
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  child: Container(
                      padding: EdgeInsets.fromLTRB(0, 12, 5, 10),
